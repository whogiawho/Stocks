...
public class SAm3Task extends SAmTask {
    public SAm3Task(SAm3Manager man, 
    ...
    public boolean printMatched(SAm dstSAm, TradeDates tradeDates, SAmOption option, AmManager amm) {
        ...
        if(!SAm3.inTriggered(dstSAm, lines))
            return bFound;
        ...
        String sFormat = "%s: %s %s %s| %s %s\n";
        System.out.format(sFormat, 
                dstSAm, lines[0], lines[1], lines[2], sLong, sShort);
